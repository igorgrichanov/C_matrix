...
START_TEST(create_matrix_test_1) {
  ...
  ck_assert_int_eq(create_matrix(0, 4, &result), INCORRECT_MATRIX);
...
START_TEST(create_matrix_test_2) {
  matrix_t result = {NULL, 0, 0};
  ck_assert_int_eq(create_matrix(4, 0, &result), INCORRECT_MATRIX);
...
START_TEST(create_matrix_test_3) {
  matrix_t result = {NULL, 0, 0};
  ck_assert_int_eq(create_matrix(0, 0, &result), INCORRECT_MATRIX);
  ck_assert_int_eq(result.rows, 0);
}
END_TEST
...
START_TEST(create_matrix_test_4) {
  ...
  ck_assert_int_eq(create_matrix(5, 5, result), INCORRECT_MATRIX);
}
END_TEST

START_TEST(create_matrix_test_5) {
  matrix_t result = {NULL, 0, 0};
  ck_assert_int_eq(create_matrix(1, 1, &result), OK);
...
START_TEST(create_matrix_test_6) {
  matrix_t result = {NULL, 0, 0};
  ck_assert_int_eq(create_matrix(2, 1, &result), OK);
...
START_TEST(create_matrix_test_7) {
  matrix_t result = {NULL, 0, 0};
  ck_assert_int_eq(create_matrix(20, 30, &result), OK);
...
START_TEST(create_matrix_test_8) {
  matrix_t result = {NULL, 0, 0};
  ck_assert_int_eq(create_matrix(-1, 0, &result), INCORRECT_MATRIX);
  ck_assert_int_eq(result.rows, 0);
}
END_TEST
...
START_TEST(create_matrix_test_9) {
  matrix_t result = {NULL, 0, 0};
  ck_assert_int_eq(create_matrix(-1, -1, &result), INCORRECT_MATRIX);
  ck_assert_int_eq(result.rows, 0);
}
END_TEST
...
START_TEST(create_matrix_test_10) {
  matrix_t result = {NULL, 0, 0};
  ck_assert_int_eq(create_matrix(5, -1, &result), INCORRECT_MATRIX);
  ck_assert_int_eq(result.rows, 0);
}
END_TEST
...
START_TEST(create_matrix_test_11) {
  matrix_t result;
  ck_assert_int_eq(create_matrix(5, 5, &result), OK);
...
START_TEST(create_matrix_test_12) {
  matrix_t result;
  ck_assert_int_eq(create_matrix(5, 0, &result), INCORRECT_MATRIX);
}
END_TEST
