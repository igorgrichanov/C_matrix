...
Implementation of the matrix.h library in C programming language using structured approach.

## Description

In this project my own library for processing numerical matrices in the C programming language was implemended. Matrices are one of the basic data structures in programming, e.g. they are used to represent table values, for computational tasks and neural networks.
